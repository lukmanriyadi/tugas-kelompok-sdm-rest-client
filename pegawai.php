                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="tambah_penggajian.php?id=<?php echo $a['id_pegawai']; ?>" type="button" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="View">
                                                                    <i class="mdi mdi-plus"></i>
                                                                </a>
                                                            </td>
                                                            <td>
                                                                <a href="detail-pegawai.php?id=<?php echo $a['id_pegawai']; ?>" type="button" class="btn btn-outline-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="View">
