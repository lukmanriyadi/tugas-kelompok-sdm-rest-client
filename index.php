...
?>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard | Indomobil - Pusat data SDM</title>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active">Welcome to Pusat data SDM Indomobil</li>
                                    </ol>
                                </div>
                            </div>
                    ...
                    <div class="page-content-wrapper">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="card" style="padding-left:25px; padding-right:25px; padding-top:10px; padding-bottom:10px;">
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media my-2">
                                                    <div class="media-body">
                                                        <p class="text-muted mb-2">Jumlah Department </p>
                                                        <h5 class="mb-0">5</h5>
                                                    </div>
                                                    <div class="icons-lg ml-2 align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media my-2">
                                                    <div class="media-body">
                                                        <p class="text-muted mb-2">Jumlah Penggajian</p>
                                                        <h5 class="mb-0">43</h5>
                                                    </div>
                                                    <div class="icons-lg ml-2 align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media my-2">
                                                    <div class="media-body">
                                                        <p class="text-muted mb-2">Jumlah Absensi</p>
