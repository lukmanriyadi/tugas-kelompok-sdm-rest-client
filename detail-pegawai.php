...
if (!isset($_GET['id'])) {
    ...
    $response_gaji = $client->request('GET', '/api/penggajian/perPegawai', [
        'query' => ['id' => $_GET['id']]
    ]);
    $result_gaji = json_decode($response_gaji->getBody()->getContents(), true);

    $response_absen = $client->request('GET', '/api/absensi/perPegawai', [
        'query' => ['id' => $_GET['id']]
    ]);
    $result_absen = json_decode($response_absen->getBody()->getContents(), true);
}
...
?>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Data Pegawai | Indomobil - Pusat data SDM</title>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">Informasi Pegawai</h4>
                                            <table id="table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><?= $result['data'][0]['nama_depan']; ?> <?= $result['data'][0]['nama_belakang']; ?></td>
                                                            <td><?= $result['data'][0]['nama_divisi']; ?></td>
                                                            <td><?= $result['data'][0]['nama_jabatan']; ?></td>
                                                            <td><?= $result['data'][0]['TTL']; ?></td>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">Absensi Pegawai</h4>
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">

                                                <thead>
                                                    <tr>
                                                        <th class="col-head">No</th>
                                                        <th class="col-head">ID Absensi</th>
                                                        <th class="col-head">Periode</th>
                                                        <th class="col-head">Tanggal Absensi</th>
                                                        <th class="col-head">Status</th>
                                                        <th class="col-head">Keterangan</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $i = 1;
                                                    foreach ($result_absen['data'] as $a) {
                                                    ?>
                                                        <tr>
                                                            <td><?= $i++; ?></td>
                                                            <td><?php echo $a['id_absen']; ?></td>
                                                            <td><?php echo $a['periode']; ?></td>
                                                            <td><?php echo $a['tanggal_absen']; ?></td>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">Informasi Gaji Pegawai</h4>
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">

                                                <thead>
                                                    <tr>
                                                        <th class="col-head">No</th>
                                                        <th class="col-head">ID Penggajian</th>
                                                        <th class="col-head">Periode</th>
